...
import random
pnr=1024
mydb=mysql.connector.connect(host="localhost",user="root",passwd="",database="rail");
...
def traindetail():
    ...
    while (ch=='y'):
        ...
        l.append(des)
        train=(l)
        sql="insert into traindetail(tname,tnum,ac1,ac2,ac3,slp,src,des) values(%s,%s,%s,%s,%s,%s,%s,%s)"
